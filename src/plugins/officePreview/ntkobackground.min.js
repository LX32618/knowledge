 ...
 */
 ...
 var ntkoWinOpen=["ntkoWinOpen1","ntkoWinOpen2","ntkoWinOpen3","ntkoWinOpen4","ntkoWinOpen5","ntkoWinOpen6","ntkoWinOpen7","ntkoWinOpen8","ntkoWinOpen9","ntkoWinOpen10","ntkoWinOpen11","ntkoWinOpen12"];
 var ntkoList=[];
 var ntkoJsonIe;
 var  timer;
...
export var ntkoBrowser = {
 ...
 {	
	 if(ntkoBrowserNoExpireKey==null||ntkoBrowserNoExpireKey=='')
	 {
		 ntkoBrowserNoExpireKey="CB35324FED9B9D9A4FC39060C30524EF";
	 }
	 ...
	 jsonValue += '}';
			 ...
			 ntkoWinOpen[i]=window.open(strURL,ntkowin,"height="+ntkoheight+", width="+ntkowidth+", top=0,left=0,titlebar=no,toolbar =no, menubar=no, scrollbars=no, resizable=yes, location=no, status=no");
			 ...
			 ntkoWinOpen[ntkoi]=window.open(strURL,ntkowin,"height="+ntkoheight+", width="+ntkowidth+", top=0,left=0,titlebar=no,toolbar =no, menubar=no, scrollbars=no, resizable=yes, location=no, status=no");
