  ...
  <el-row class="content-container">
    <el-col :span="18">
      <el-card>
        ...
        <!-- 评论列表 -->
        <a-comment
          v-for="comment of pagedComments"
          :key="comment.id"
          :author="
            `${comment.userName}${
              comment.replayName ? ' 回复 ' + comment.replayName : ''
            }`
          "
        ...
        >
          ...
          <template slot="actions">
            <el-input
              v-show="comment.id === activeCommentId"
              size="mini"
...
import {
  findCommentsByKnowledgeId,
  saveComment,
  deleteComment
} from '@/api/knowledgeComment'
