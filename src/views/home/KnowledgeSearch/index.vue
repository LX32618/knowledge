    ...
    <div class="container">
      <el-row class="wrapper">
        ...
        <el-col class="hot-words" :span="6">
          <el-card header="你可能感兴趣">
            <div v-loading="searchLoading || hotWordsLoading">
              <div
                class="hot-word"
...
import { solrSearch, getHotWords } from '@/api/solr'
...
export default {
  ...
  async mounted () {
    ...
    this.hotWords = (await getHotWords()).content
